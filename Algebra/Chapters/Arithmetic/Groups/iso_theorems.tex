...
\begin{theorem}
    [Secondo Teorema degli Omomorfismi] {second_iso}
...
\begin{proof}
    ...
    \begin{description}
        \item[($N \normal HN$)] Mostriamo innanzitutto che $HN$ è un sottogruppo di $G$. Per la \Cref{prop:cond_prod_sgr_e'_sgr}, è sufficiente mostrare che $HN = NH$. 
