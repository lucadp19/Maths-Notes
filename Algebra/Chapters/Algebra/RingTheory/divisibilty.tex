...
\begin{proof}
    ...
    \begin{description}
        ...
        Tuttavia $x$ è irriducibile, dunque uno tra $z$ e $y$ deve essere invertibile, ma per l'osservazione appena sopra sappiamo che $y \notin \units{A}$, dunque $z$ è invertibile. Da questo segue che $x \sim y$, da cui per la \Cref{prop:caratt_associati} $\ideal{x} = \ideal{y}$, ovvero $\ideal{x}$ è massimale tra gli ideali principali.
