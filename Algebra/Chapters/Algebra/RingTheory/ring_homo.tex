...
Come nel caso dei gruppi esiste un omomorfismo \begin{align*}
    \pi_I : A &\to \quot{A}{I}    \\
    a &\mapsto a + I
\end{align*} detto \strong{proiezione al quoziente}. Come nel caso dei gruppi, la sua immagine è $\Imm \pi_n = \quot{A}{I}$ (ovvero $\pi_I$ è surgettivo) mentre il suo nucleo è $\ker \pi_I = I$. Vale quindi un analogo della \Cref{prop:rel_kernel_sgr_normali}.
...
\begin{proof}
    ...
    Sia quindi $\AA$ l'insieme degli ideali di $A$ contenenti $I$ e sia $\BB$ l'insieme degli ideali di $\quot{A}{I}$. Per il \Cref{lem:ideals_and_homos} vale che \begin{itemize}
