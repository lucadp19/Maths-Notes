...
\begin{proof}
    ...
    \begin{description}
        ...
        Siccome $p$ è irriducibile ha come divisori soltanto $\pm 1$ e $\pm p$, dunque $\gcd{p}{a} = 1$. Inoltre per ipotesi $p \divides ab$, dunque per il \Cref{lem:divide_prod_coprimo_col_primo} segue che $p \divides b$, dunque $p$ è primo.
    \end{description}
\end{proof}
