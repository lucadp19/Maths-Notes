...
\begin{proof}
    ...
    \begin{description}
        ...
        \item[\boximplby] $ax + by = c$ ha soluzione, dunque per la \Cref{prop:cond_nec_suff_diofantee} segue che $\gcd{a}{b} \divides 1$, ovvero $\gcd{a}{b} = 1$.
    \end{description}
\end{proof}
...
\end{corollary}
\begin{proof}
    Per la \Cref{prop:cond_nec_suff_diofantee} l'equazione $ax + by = d$ ha soluzione, ovvero esistono $x_0, y_0 \in \Z$ tali che \[
        ax_0 + by_0 = d.
    \] Siccome $a = da_1$ e $b = db_1$ possiamo dividere entrambi i membri per $d$, ottenendo \[
        a_1x_0 + b_1y_0 = 1,    
    \] dunque per il \Cref{cor:mcd=1_sse_comb_lin_1} segue che $\gcd{a_1}{b_1} = 1$.
\end{proof}
...
\end{lemma}
\begin{proof}
    Per il \Cref{cor:mcd=1_sse_comb_lin_1} sappiamo che esistono $x_0, y_0 \in \Z$ tali che \[
        mx_0 + ay_0 = 1.    
