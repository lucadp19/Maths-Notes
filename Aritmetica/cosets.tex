...
\begin{proposition}
    Sia $(G, \cdot)$ un gruppo e sia $N \normal G$. Allora la struttura $(\quot{G}{N}, *)$ (dove l'operazione è definita come in \eqref{eq:op_gruppo_quoziente}) è un gruppo.
\end{proposition}
\begin{proof}
...
\end{corollary}
\begin{proof}
    Infatti se $N \normal G$ allora per la \autoref{prop:kernel_proiezione} segue che $N = \ker \pi_N$; se $N = \ker \phi$ per la \autoref{prop:rel_kernel_sgr_normali} $N$ è normale.
\end{proof}