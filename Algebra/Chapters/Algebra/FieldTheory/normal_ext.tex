...
\begin{proof}
    ...
    \begin{description}
        ...
        Dato che $\ext{\F / \K}$ è finita a maggior ragione lo sarà $\ext{\F / \K(\alpha_1)}$. Per la \Cref{prop:finite_ext_embedding} possiamo allora estendere ogni $\phi_i$ ad un'immersione definita su $\F$: \[
